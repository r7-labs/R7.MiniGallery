...
// REVIEW: Don't use imagehandler if both width and height isn't set
// REVIEW: Separate setting for image dimension units (same for width and height)
// REVIEW: Display image title only on hover
